...
if (isset($_POST['save'])) {
    $id             = htmlentities(strip_tags(trim($_POST['idpelanggan'])));
    ...
    if ($pesan_error === "") {
        ...
        if (mysqli_query($koneksi, $query)) {
            ...
            // echo "<meta http-equiv='refresh' content='1;url=http://localhost//admin-index/index.php?view-input=buah'>";
        } else {
            # code...
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post" class=" col-sm-3 md-4">
                                        ...
                                        if (isset($_POST['cari'])) {
                                            # code...
                                            $id = $_POST['idcari'];
                                            $tampil_pelanggan = $koneksi->query("select * from pelanggan where (nama_depan LIKE '%$id%') or (nama_belakang LIKE '%$id%') ;");
                                        }
                                        ?>
                                    </form>
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php while ($data = $tampil_pelanggan->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <!-- <td><?= $data['']; ?></td> -->
                                                        <td>
                                                            <a href="edit-data/edit-pelanggan.php?id=<?= $data['id_pelanggan']; ?>" class="btn btn-warning btn-rounded btn-fw" data-toggle="tooltip" data-placement="top" title="Edit Pelanggan">
                                                                <i class="mdi mdi-tooltip-edit" aria-hidden="true"></i>
                                                            </a>
                                                            <a href="config/delete-pelanggan.php?id=<?= $data['id_pelanggan']; ?>" class="btn btn-danger btn-rounded btn-fw" data-toggle="tooltip" data-placement="top" title="Hapus Pelanggan">
