...
if (isset($_POST['save'])) {
    ...
    if ($pesan_error === "") {
        ...
        # code...
        $query = "update login set nama='$namalengkap',email='$email',password='$password' where id_login='$id'";
        if (mysqli_query($koneksi, $query)) {


            echo "<script> alert('Berhasil Tersimpan');</script>";
            $tampil_admin = $koneksi->query("select * from login");
            echo "<script>location='../input-admin.php'</script>";
        } else {
            # code...
    ...
    # code...
    $tampil_admin = $koneksi->query("select id_login,nama,email,password from login where id_login='$_GET[id]'");
    $data = $tampil_admin->fetch_assoc();
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="laporan">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="laporan-produk.php">Laporan Produk</a></li>
                                <li class="nav-item"><a class="nav-link" href="laporan-pelanggan.php">Laporan Pelanggan</a></li>
                                <li class="nav-item"><a class="nav-link" href="laporan-kategori.php">Laporan Kategori</a></li>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Input Admin2</h4>
                                    <p class="card-description">
                                        Silahkan melakukan edit data Admin
                                    </p>
                                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="namalengkap" placeholder="namalengkap" name="namalengkap" value="<?= $namalengkap ?>">
                                        </div>
                                        <div class="form-group">
