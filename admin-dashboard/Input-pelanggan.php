...
if (isset($_POST['save'])) {
    ...
    if ($pesan_error === "") {
        # code...
        $query = "insert into pelanggan values('$idpelanggan','$namadepan','$namabelakang','$alamat','$kodepos','$notelp','$email','$password')";
        if (mysqli_query($koneksi, $query)) {
            ...
            echo "<meta http-equiv='refresh' content='1;url=http://localhost/penjualan-master/admin-dashboard/input-pelanggan.php'>";
        } else {
            # code...
...
if (isset($_POST['cancel'])) {
    // echo "<meta http-equiv='refresh' content='1;url=http://localhost/penjualan-master/admin-dashboard/data-pelanggan.php'>";
}
                ...
                ";
                                    ...
                                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="idpelanggan" name="idpelanggan" readonly value="<?php echo $kodePelanggan ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="namadepan">Nama Depan</label>
                                            <input type="text" class="form-control" id="namadepan" placeholder="namadepan" name="namadepan">
                                        </div>
                                        <div class="form-group">
                                            <label for="namabelakang">Nama Belakang</label>
                                            <input type="text" class="form-control" id="namabelakang" placeholder="namabelakang" name="namabelakang">
                                        </div>
                                        <div class="form-group">
                                            <label for="alamat">Alamat</label>
                                            <input type="textarea" class="form-control" id="alamat" placeholder="alamat" name="alamat">
                                        </div>
                                        <div class="form-group">
                                            <label for="kodepos">Kode Pos</label>
                                            <input type="text" class="form-control" id="kodepos" placeholder="kodepos" name="kodepos">
                                        </div>
                                        <div class="form-group">
