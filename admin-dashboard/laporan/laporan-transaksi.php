                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">
                                        Transaksi Pembayaran masuk
                                    </p>
                                    <form action="print-transaksi-periode.php" method="post">
                                        <div class="row">
                                            <div class="col-sm-2"> Berdasarkan Tanggal</div>
                                            <div class="col-sm-2">
                                                <input type="date" name="tanggal" class="col-sm-2 form-control " value="<?= date('Y-m-d') ?>">
                                            </div>
                                            <div class="col-sm-2">
                                                <button name="hari" target="_blank" class="btn btn-outline-info btn-icon-text">Cetak Laporan</button>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm-2"> Berdasarkan Bulan</div>
                                            <div class="col-sm-2">
                                                <select name="bulan" class="form-select" data-live-search="true">
                                            ...
                                            <div class="col-sm-2">
                                                <button name="periode" target="_blank" class="btn btn-outline-info btn-icon-text">Cetak Laporan</button>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm-2">Cetak Semua</div>
                                            <div class="col-sm-2">
                                                <a href="print-transaksi.php" target="_blank" class="btn btn-outline-info btn-icon-text">Cetak Laporan</a>
                                            </div>
                                        </div>
                                    </form>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } elseif ($data['status'] == 'Selesai') { ?>
                                                            <label class="badge badge-primary"><?= $data['status']; ?></label>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
