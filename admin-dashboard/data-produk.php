                                    ...
                                    <div class="table-responsive">
                                        <form action="" method="post" class=" col-sm-3 md-4">
                                            ...
                                            if (isset($_POST['cari'])) {
                                                # code...
                                                $id = $_POST['idcari'];
                                                $tampil_produk = $koneksi->query("select id_produk,nama_produk,harga_produk,id_kategori,foto_produk,SUBSTR(deskripsi_produk, 1, 25) AS deskripsi_produk,stok_produk from produk WHERE (nama_produk LIKE '%$id%') or (stok_produk LIKE '%$id%') ;");
                                            }
                                            ?>
                                        </form>
                                        <?php
                                        $total_kurang = $total_kurang->fetch_assoc();
                                        $total = number_format($total_kurang['total_kurang']);
                                        if ($total >= 1) {
                                        ?>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php while ($data = $tampil_produk->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <!-- <td><?= $data['']; ?></td> -->
                                                        <td>
                                                            <a href="edit-data/edit-produk.php?id=<?= $data['id_produk']; ?>" class="btn btn-warning btn-rounded btn-fw" data-toggle="tooltip" data-placement="top" title="Edit Produk">
                                                                <i class="mdi mdi-tooltip-edit" aria-hidden="true"></i>
                                                            </a>
                                                            <a href="config/delete-produk.php?id=<?= $data['id_produk']; ?>" class="btn btn-danger btn-rounded btn-fw" data-toggle="tooltip" data-placement="top" title="Hapus Prooduk">
