...
if (isset($_POST['save'])) {
    $idkategori   = htmlentities(strip_tags(trim($_POST['idkategori'])));
    $namakategori = htmlentities(strip_tags(trim($_POST['namakategori'])));

    $pesan_error = "";

    if (empty($idkategori)) {
        $pesan_error .= "Id Kategori belum diisi <br>";
    }
    if (empty($namakategori)) {
        $pesan_error .= "Nama Kategori belum diisi <br>";
    }
                ...
                ";
                                    ...
                                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="idkategori" placeholder="idkategori" name="idkategori">
                                        </div>
                                        <div class="form-group">
