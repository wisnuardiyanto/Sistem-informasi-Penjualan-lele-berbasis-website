                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post" class=" col-sm-3 md-4">
                                        ...
                                        if (isset($_POST['cari'])) {
                                            # code...
                                            $id = $_POST['idcari'];
                                            $perlu_dikirim = $koneksi->query("select * from transaksi where status='Dibayar' and ((id_transaksi LIKE '%$id%') or (waktu_transaksi LIKE '%$id%')) ;");
                                        }
                                        ?>
                                    </form>
                                    <div class="table-responsive">
                                        <table class="table table-striped-hover" id="table1">
                                            ...
                                            <tbody>
                                                <?php while ($data = $perlu_dikirim->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                ...
                                                                <button type="button" class="btn btn-inverse-primary btn-fw" data-bs-toggle="modal" data-bs-target="#modalCenter<?= $data['id_transaksi']; ?>">
                                                                    <i aria-hidden="true">Input Resi</i>
                                                                </button>
                                                                <!-- Modal -->
                                                            ...
                                                            if (isset($_POST['save'])) {
                                                                ...
                                                                $resi = htmlentities(strip_tags(trim($_POST['resi'])));

                                                                $query = "update transaksi set resi='$resi',status='Dikirim' where id_transaksi='$id_transaksi' ";
                                                                if (mysqli_query($koneksi, $query)) {

                                                                    echo "
                                                        <script>
                                                        alert('Berhasil Input Resi');
                                                        </script>";
