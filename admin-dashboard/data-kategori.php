...
if (isset($_POST['save'])) {
    ...
    if ($pesan_error === "") {
        # code...
        $query = "insert into kategori values('$idkategori','$namakategori')";
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post" class=" col-sm-3 md-4">
                                        ...
                                        if (isset($_POST['cari'])) {
                                            # code...
                                            $id = $_POST['idcari'];
                                            $tampil_kategori = $koneksi->query("select * from kategori where (id_kategori LIKE '%$id%') or (nama_kategori LIKE '%$id%') ;");
                                        }
                                        ?>
                                    </form>
                                            ...
                                            <tbody>
                                                <?php while ($data = $tampil_kategori->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <!-- <td><?= $data['']; ?></td> -->
                                                        <td>
                                                            <a href="edit-data/edit-kategori.php?id=<?= $data['id_kategori']; ?>" class="btn btn-warning btn-rounded btn-fw" data-toggle="tooltip" data-placement="top" title="Edit kategori">
                                                                <i class="mdi mdi-tooltip-edit" aria-hidden="true"></i>
                                                            </a>
                                                            <a href="config/delete-kategori.php?id=<?= $data['id_kategori']; ?>" class="btn btn-danger btn-rounded btn-fw" data-toggle="tooltip" data-placement="top" title="Hapus Pelanggan">
